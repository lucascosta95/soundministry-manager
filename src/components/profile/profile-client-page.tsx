...
export default function ProfileClientPage({ initialProfile }: ProfileClientPageProps) {
  ...
  const handleUpdateProfile = async (e: React.FormEvent) => {
    ...
    try {
        ...
        formData.append("preferredTheme", profile.preferredTheme)
        formData.append("preferredLocale", profile.preferredLocale)
  ...
  const handleChangePassword = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        toast({
          title: result.error === "Current password is incorrect" 
